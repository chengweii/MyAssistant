...
public class ServiceUtil {
	 ...
	 *            服务类
	 */
	public static void startService(Context context, String className, String extraInfo) {
		try {
			startService(context, Class.forName(className), extraInfo);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
